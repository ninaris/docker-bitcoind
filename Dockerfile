...
COPY ./bitcoin/src/bitcoin-cli /usr/local/bin/bitcoin-cli
COPY ./bitcoin/src/bitcoin-tx /usr/local/bin/bitcoin-tx
COPY ./bitcoin/src/bitcoind /usr/local/bin/bitcoind
